        ...
        <a-row :gutter="48">
          ...
          <template v-if="advanced">
            <a-col :md="8" :sm="24">
              <a-form-item label="文章状态">
                <a-select placeholder="请选择" v-model="queryParam.state" default-value="1">
          ...
          <a-col :md="(!advanced && 8) || 24" :sm="24">
            ...
            >
              ...
              <a-button style="margin-left: 8px" @click="() => (queryParam = { newType: queryParam.newType })"
                >重置</a-button
              >
...
export default {
  ...
  methods: {
    ...
    gotoAdd() {
      this.$router.push({ name: 'artadd', params: { type: 'list', typeKey: this.queryParam.newType } })
    },
    handleDetail(record) {
      console.log(record)
