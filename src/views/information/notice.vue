        ...
        <a-row :gutter="48">
          ...
          <a-col :md="(!advanced && 8) || 24" :sm="24">
            ...
            >
              ...
              <a-button style="margin-left: 8px" @click="() => (queryParam = { newType: '4' })">重置</a-button>
...
import { SysNewsList } from '@/api/news'
...
export default {
  ...
  methods: {
    ...
    gotoAdd() {
      this.$router.push({ name: 'artadd', params: { type: 'notice', typeKey: this.queryParam.newType } })
    },
    handleEditClose() {
